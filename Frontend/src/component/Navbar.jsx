      ...
      <div className="md:w-[80%] w-[92%] flex items-center justify-between my-4 ">
        ...
        <div className=" md:block hidden">
          <ul className="w-full flex text-[17px] items-center justify-evenly gap-10 link-active font-semibold">
            ...
            <NavLink to="/doctor"
              className={({ isActive }) => `text-black ${isActive ? "bg-blue-500 px-3 py-1 rounded text-white duration-300 transform transition-all ease-in" : ""}`}
            >
              All Doctors
            </NavLink>
            <NavLink to="About"
              className={({ isActive }) => `text-black ${isActive ? "bg-blue-500 px-3 py-1 rounded text-white transform transition-all" : ""}`}
            >
              About
            </NavLink>
            <NavLink to="Contact"
        ...
        <button className=" hidden lg:block px-3 py-2 bg-blue-500 text-white text-sm font-medium rounded" onClick={() => window.open("https://healthpoint-appointment-admin.onrender.com", "_blank")} >Admin Panel</button>
        ...
        >
          <ul className="w-full h-[80%] flex flex-col items-center justify-between mobile-link text-2xl font-medium">
            ...
            <NavLink to="/"
              className={({ isActive }) => `text-black  ${isActive ? "bg-blue-400" : ""}`} onClick={() => setSideBar(!sideBar)}>Home</NavLink>
            <NavLink to="/doctor"
