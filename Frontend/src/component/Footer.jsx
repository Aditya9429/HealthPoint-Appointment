        ...
        <footer className="text-black mt-10">
            <div className="max-w-7xl mx-auto py-12 px-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-2 gap-30">
                    ...
                    <div>
                        <h1 className="text-3xl text-[#000B6D] font-bold mb-4">Prescripto</h1>
                    ...
                    <div className="flex flex-col gap-6">
                        <h1 className="text-lg font-semibold mb-3 uppercase">Company</h1>
                        <div className="flex flex-col gap-2">
                            ...
                            <p className="cursor-pointer hover:text-gray-300" >Delivery</p>
                            <p className="cursor-pointer hover:text-gray-300">Privacy</p>
                        </div>
                    </div>

                    <div className='flex flex-col gap-6'>
                        <h1 className="text-lg font-semibold mb-3 uppercase">Get In Touch</h1>
